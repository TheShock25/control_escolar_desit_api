...
class Materias(models.Model):
    id = models.BigAutoField(primary_key=True)
    nrc = models.CharField(max_length=20, null=False, blank=False, unique=True)
    nombre = models.CharField(max_length=255, null=False, blank=False)
    seccion = models.CharField(max_length=10, null=False, blank=False)
    dias_json = models.TextField(null=False, blank=False)
    hora_inicio = models.TimeField(null=False, blank=False)
    hora_final = models.TimeField(null=False, blank=False)
    salon = models.CharField(max_length=50, null=False, blank=False)
    programa_educativo = models.CharField(max_length=10, null=False, blank=False)
